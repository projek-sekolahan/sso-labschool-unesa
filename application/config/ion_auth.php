...
*/
$config['tables']['users_login']		= 'users_login';
$config['tables']['users_details']		= 'users_details';
$config['tables']['groups']				= 'groups';
$config['tables']['users_groups']		= 'users_groups';
$config['tables']['login_attempts']		= 'login_attempts';
$config['tables']['permissions']			= 'permissions';
$config['tables']['groups_has_permissions']	= 'groups_has_permissions';
$config['tables']['token']	= 'token';
 ...
 */
$config['join']['users_login']		= 'user_id';
$config['join']['users_details']	= 'user_id';
$config['join']['groups']		= 'group_id';
$config['join']['permissions']	= 'permission_id';
$config['join']['groups_has_permissions']	= 'groups_id';
$config['join']['token']	= 'user_id';
...
$config['user_expire']                = 7200;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
$config['email_config'] = [
	...
	'smtp_host' =>  "mail.smalabschoolunesa1.sch.id",
	'smtp_port' =>  465,   // 465 with ssl , 587 tls
	// 'smtp_user' =>  "info_presensi@".$_SERVER['HTTP_HOST'],
	'smtp_user' =>  "info_presensi@smalabschoolunesa1.sch.id",
...
$config['message_start_delimiter'] = '<br />'; 	// Message start delimiter
$config['message_end_delimiter']   = '<br />'; 	// Message end delimiter
$config['error_start_delimiter']   = '<br />';	// Error message start delimiter
